    ...
    try {
        ...
        btnPanier?.addEventListener('click', async () => {
            try {
                ...
                console.error(err);
                alert("Impossible d'ajouter au panier (le serveur est-il lancé (npm run dev sur le port 3000) ?)");
            }
        });
        ...
        btnFavori?.addEventListener('click', async () => {
            try {
                ...
                console.error(err);
                alert('Impossible de mettre à jour les favoris (le serveur est-il lancé (npm run dev sur le port 3000) ?)');
            }
        });
